...
export default function NavBar() {
  return (
    <nav className="border-r bg-white  dark:bg-gray-800/40">
      <div className="flex h-full max-h-screen flex-col gap-2">
        ...
        <div className="flex-1 overflow-auto py-2">
          ...
          <Link
            ...
            <Link
              className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50"
              href="/project_dashboard/FileUpload/FileList"
            >
            ...
            <Link
              className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50"
              href="/project_dashboard/Form/FormList"
            >
            ...
            <Link
              className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50"
              href="/project_dashboard/Document/DocumentList"
            >
              <BrowseIcon className="h-4 w-4" />
              Document
            </Link>
            <Link
              className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50"
              href="/project_dashboard/Analyze/List"
            >
            ...
            <Link
              className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50"
              href="/project_dashboard/Setting"
            >
