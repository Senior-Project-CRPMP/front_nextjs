      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full md:w-3/4 lg:w-2/3">
        ...
        <form className="space-y-4">
          <label className="form-box">
            <p className="form-label text-gray-700 font-medium mb-2">
              {" "}
              Form Title:
            </p>
            <input
              ...
              {field.type === "date" && (
                <>
                  <input
                    type="date"
                    disabled
                    className="px-3 py-2 border border-gray-300 rounded-md text-gray-500 cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />{" "}
                  <br />
                </>
              )}
              {field.type === "time" && (
                <>
                  <input
                    type="time"
                    disabled
                    className="px-3 py-2 border border-gray-300 rounded-md text-gray-500  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />{" "}
                  <br />
                </>
              )}
