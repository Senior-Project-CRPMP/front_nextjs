    ...
    <div id="home" ref={divRef}>
      <header
        className={`fixed top-0 left-0 right-0 z-10 transition-colors duration-300 ${
          headerBackground === 'transparent' ? 'bg-transparent' : 'bg-indigo-500 shadow-md'
        }`}
      >
      ...
      >
        ...
        <div className="container mx-auto h-full flex flex-col justify-center items-center text-white">
          ...
          <h1 className="mb-4 font-normal italic text-white tracking-wider text-2xl md:text-4xl ">
            Comprehensive Research And Project Management Platform
          </h1>
      ...
      <div className="flex justify-center mt-6">
            <Link href="/signup">
              <button className="bg-indigo-500 hover:bg-indigo-600 text-white py-3 px-8 rounded-full text-lg shadow-lg transform transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                Get Started
              </button>
            </Link>
          </div> 
